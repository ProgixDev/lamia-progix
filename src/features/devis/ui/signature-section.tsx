...
import { useFormule } from "./use-formule";
...
export function SignatureSection() {
  ...
  // Reflect the formule chosen in section 04 (shared external store).
  const formule = useFormule();
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formuleRecap}>
          ...
          <span className={styles.formuleRecapValue}>
            {formule ? FORMULE_LABELS[formule] : "à sélectionner à la section 04 — Formules"}
          </span>
        </div>
